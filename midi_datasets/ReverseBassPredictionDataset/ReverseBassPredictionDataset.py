...
_DESC = """
Dataset with midi files, with bass extracted to source_notes and the rest in target_notes columns.
...
class BassPredictionDataset(MidiSequenceDataset):
    ...
    def create_record(self, piece: ff.MidiPiece) -> tuple[dict, bool]:
        notes = piece.df
        bass_range = get_voice_task_range("bass_prediction")
        ...
        record = {
            ...
            "prediction_task": "reverse_bass_prediction",
